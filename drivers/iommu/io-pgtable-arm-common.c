...
static int arm_lpae_map_pages(struct io_pgtable *iop, unsigned long iova,
...
{
	return arm_lpae_map_pages(iop, iova, paddr, size, 1, iommu_prot, gfp,
				  NULL);
}
...
{
	return arm_lpae_unmap_pages(iop, iova, size, 1, gather);
}
